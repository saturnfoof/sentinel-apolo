...
module.exports = (client) => {
  client.on("messageCreate", async message => {
    ...
    // Substitua 'someUserId' pelo ID do usuário e adicione IDs à whitelist
    const someUserId = '1072608696129028146';
    const whitelist = ['1072608696129028146', '471313947585282050']; // Adicione IDs aqui

    // Se o autor da mensagem estiver na whitelist, não faça nada
